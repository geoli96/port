    ...
    return (
        <div>
            ...
            <div className="mobileheader">
                <div className="logo mobile">GL</div>
                <div
                    onClick={() => setMenuVisible((menuVisible) => !menuVisible)}
                    style={{
                        padding: "10px",
                        cursor: "pointer",
                        backgroundColor: menuVisible ? "rgb(0,0,0,0.3)" : "",
            ...
            <div
                className="container"
                onClick={() => {
                    menuVisible && setMenuVisible((menuVisible) => !menuVisible);
                }}
            >
                <div className="hero">
                    <h1>Hi, my name is Georgij.</h1>
                    <div className="bio">
                        I'm a Fullstack Developer with a passion for developing applications that help solve real life
                        problems. I also enjoy web design and building applications that look good and provide a good
                        user experience.
                    </div>
                </div>
                ...
                <div className="project">
                    <div className="infosection about">
                        ...
                        <br />
                        <div style={{ fontSize: "18px" }}>
                            My main focus when developing applications is providing a smooth, functional and visually
                            pleasing experience for the user, while also making sure that the application is secure and
                            performant.
                        </div>
                        <br></br>
                        <div style={{ fontSize: "18px" }}>
                ...
                <div className="project">
                    <div className="infosection">
                        ...
                        <div style={{ fontSize: "18px" }}>
                            ...
                            pieces into their correct spot. You get to choose difficulty and if you get stuck you can
                            press a button that lets an implementation of A* search algorithm solve the puzzle for you.
                            It is possible to play with others online through turn based cooperation. When playing with
                            others there is a chat. The chat was implemented using Socket.io for low latency messaging.
                        </div>

                        <div style={{ fontWeight: "400", paddingTop: "30px", fontSize: "18px" }}>
                            <span>Used technologies:</span>{" "}
                            <span style={{ fontWeight: "600" }}>React, Node.js, MongoDB, Express.js and Socket.io</span>{" "}
                        </div>
                        <br />
                        <div style={{ display: "flex", gap: "20px", paddingTop: "20px" }}>
                            <div style={{ fontWeight: "600", fontSize: "16px", cursor: "pointer" }}>
                                <a
                                    ...
                                    href="https://github.com/goshaaz/8-puzzle-game"
                                >
                                    Code
                                </a>
                            </div>
                            <div style={{ fontWeight: "600", fontSize: "16px", cursor: "pointer" }}>
                                <a
                                    style={{ textDecoration: "none", color: "inherit" }}
                                    href="https://eight-star-puzzle.herokuapp.com/"
                                >
                                    Demo
                                </a>
                            </div>
                    ...
                    <div className="rightside">
                        <div className="image">
                                ...
                                {puzzleImages.map((item, index) => {
                                    return (
                                        <div
                                            ...
                                            style={{
                                                backgroundColor:
                                                    index === currentImagePuzzle ? "rgb(0,0,0,0.7)" : "rgb(0,0,0,0.15)",
                                            }}
                                        />
                                    );
                                })}
                            ...
                            <img
                                ...
                                style={{ objectFit: currentImagePuzzle === 2 ? "contain" : "cover" }}
                                src={puzzleImages[currentImagePuzzle]}
                            ></img>
                                ...
                                <div>
                                    {currentImagePuzzle > 0 ? (
                                        <img
                                            alt="arrow"
                                            onClick={() => {
                                                setCurrentImagePuzzle(currentImagePuzzle - 1);
                                            }}
                                            className="arrow"
                                            src={leftarrow}
                                        ></img>
                ...
                <div className="project" style={{ paddingBottom: "0px" }}>
                    <div className="infosection about">
                        <div style={{ display: "flex", flexDirection: "column", gap: "0px" }}>
                            <div style={{ fontSize: "18px" }}>Email: ligeorgij7@hotmail.com</div>
                            <div style={{ display: "flex", gap: "10px", paddingTop: "30px" }}>
                                ...
                                <div style={{ width: "22px", height: "auto" }}>
                                    <a
                                        style={{ textDecoration: "none", color: "inherit" }}
                                        href="https://www.linkedin.com/in/georgij-li-25b7a8159/"
                                    >
                                        <img
                                            alt="projectimg"
                                            src={linkedinlogo}
            ...
            >
                <div className="footerleft">Developed by Georgij Li</div>
